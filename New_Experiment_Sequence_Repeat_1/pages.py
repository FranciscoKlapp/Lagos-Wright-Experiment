...
class Instructions_final1_both(Page):
    ...
    def vars_for_template(self):
        return dict(treatment=self.session.config['treatment'],
  ...
  #  timeout_seconds = 240
    ...
    def js_vars(self):
        return dict(
            mu = Constants.mu,
            eta = Constants.eta,
            tokens = self.player.tokens_begin,
            output = 1
        )
